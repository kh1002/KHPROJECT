			...
			<td colspan="2">
				<table border="0" width="80%">
					<form name="goodsform" action="./GoodsModifyAction.ag" method="post">
						...
						<tr>
							<td>
								<p align="center"><span style="font-size: 26pt;">상품수정</span></p>
							</td>
						</tr>
								...
								<table border="1" align="center" width="558">
									<tr>
										...
										<td width="346" height="30">
											<select name="goods_category" size="1" value="<%=agb.getGOODS_CATEGORY()%>">
									...
									<tr>
										...
										<td>
											<input type="text" name="goods_name" value="<%=agb.getGOODS_NAME()%>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="goods_price" value="<%=agb.getGOODS_PRICE()%>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="goods_color" value="<%=agb.getGOODS_COLOR()%>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="goods_amount" value="<%=agb.getGOODS_AMOUNT()%>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="goods_size" value="<%=agb.getGOODS_SIZE()%>">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="radio" name="goods_best" value="1<%if(agb.getGOODS_BEST()==1){%>CHECKED<%}%>">
											<font size="2">예</font>
											<input type="radio" name="goods_best" value="0<%if(agb.getGOODS_BEST()== 0){%>CHECKED<%}%>">
											<font size="2">아니오</font>
										</td>
									</tr>
						...
						<tr>
							<td>
								<p align="center"><input type="submit" value="수정">&nbsp;<input type="reset" value="다시쓰기"></p>
							</td>
						</tr>
