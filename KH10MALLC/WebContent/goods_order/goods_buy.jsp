...
<table widt="960" cellspacing = "0" cellpadding = "0" border="0" align="center">
<tr>
...
<table widt=80% border=0 cellpadding="0" cellspacing="1">
<tr>
	<td height=10>
	<td>
</tr>
...
<tr height=20>
	<td style="font-family: Tahoma; font-size:8pt;" width=130 height=24 bgcolor="f7f7f7">
	받는사람</td>
	<td style="font-family: Tahoma; font-size:8pt;"><input type="text" name="ORDER_RECEIVE_NAME" size=12 value="<%=member.getMEMBER_NAME() %>">
	</td>
</tr>
